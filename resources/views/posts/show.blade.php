...
{{--                <livewire:like-post :mensaje="$post"/>--}}
            </div>
            <div class="p-3">
...
{{--                <livewire:like-post/>--}}
                ...
                <form id="formDeletePost">
                    ...
                    <button id="btnEliminarPost" type="button"
                            class="border flex gap-1 p-2 mt-3 w-full font-semibold rounded-lg bg-red-600 text-white hover:bg-red-700 hidden">
            ...
            <div class="shadow bg-white p-5 mb-5">
                ...
                @if(auth()->user())
                    ...
                    <form id="formNuevoComentario">
                        ...
                        <div class="mb-5">
                            ...
                            <textarea id="comentario" name="comentario"
                                      class="border w-full p-2 border-gray-600 rounded-lg" rows="8"
                                      placeholder="Ingresa tu comentario"></textarea>
                        </div>
                        <div class="">
                            <input type="submit" value="Agregar Comentario"
                                   class="border p-2 rounded-lg w-full bg-gray-500 text-white font-semibold cursor-pointer hover:bg-gray-600">
                        </div>
                    </form>
                    ...
                    <div class=" shadow mb-5 max-h-96 hidden" id="noComentarios">
                        <p class=" text-center p-2 bg-orange-500 text-white font-semibold rounded-lg">No hay comentarios
                            disponibles</p>
                    </div>
                @else
                    <p>Inicia Sesión para Agregar Comentarios</p>
                    <a href="/iniciar-sesion"
                       class="my-4 rounded p-2 border block text-center font-semibold bg-gray-500 rounded-lg text-white hover:bg-gray-600 uppercase">Inicar
                        Sesión</a>
                @endif
            </div>
        </div>
